...
export const allMethods: Docs = new Map([
	/* --------------------------- *
	 * CBaseEntity                 *
	 * --------------------------- */
	["AcceptInput", {
...
export const allFunctions: Docs = new Map([
	["AddThinkToEnt", {
...
export const builtInEnums: Docs = new Map([
	["EBotType", {
...
export const enumMembers: InstanceDocs = new Map([
	["EBotType", new Map([
		["TF_BOT_TYPE", {
...
export const docSnippets: Map<string, DocSnippet> = new Map([
	["abstract", {
...
synonyms.forEach(([synonym, original]) => {
	if (!docSnippets.has(synonym)) {
		docSnippets.set(synonym, docSnippets.get(original) as DocSnippet);
	}
});