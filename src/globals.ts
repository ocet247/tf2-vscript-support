...
export const docSnippets: DocSnippets = {
	abstract: {
...
// Synonyms
docSnippets.virtual = docSnippets.abstract;
docSnippets.extends = docSnippets.augments;
docSnippets["constructor"] = docSnippets.class;
docSnippets.const = docSnippets.constant;
docSnippets.defaultvalue = docSnippets.default;
docSnippets.desc = docSnippets.description;
docSnippets.host = docSnippets.external;
docSnippets.fileoverview = docSnippets.overview = docSnippets.file;
docSnippets.emits = docSnippets.fires;
docSnippets.func = docSnippets.method = docSnippets.function;
docSnippets.var = docSnippets.method;
docSnippets.arg = docSnippets.argument = docSnippets.param;
docSnippets.prop = docSnippets.property;
docSnippets.return = docSnippets.returns;
docSnippets.exception = docSnippets.throws;
